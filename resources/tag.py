...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An error occurs while inserting the tag.")
        return tag
    ...
    def delete(self, item_id, tag_id):
        ...
        return {"message": "Item removed from tag", "item_id": item_id, "tag_id": tag_id}
...
class Tag(MethodView):
    ...
    @blp.response(400, description="returned if tag is linked to one or more items. In this case, the tag is not "
                                   "deleted.")
    def delete(self, tag_id):
        ...
        abort(
            400,
            message="Could not tag. Make sure tag is not associated with any items, then try again."
        )
